    ...
    >
      ...
      <div className="relative z-10 bg-white/10 backdrop-blur-md p-6 sm:p-10 rounded-2xl shadow-2xl border border-white/20 w-full max-w-md animacion-tarjeta">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-200 mt-2 font-light text-sm sm:text-base">
            Acceso al sistema
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            {loading ? (
              <svg
                className="animate-spin h-5 w-5 text-[#2A3F45]"
      ...
      <div
        className="relative z-10 bg-white/10 backdrop-blur-md p-6 rounded-2xl shadow-xl border border-white/20 w-full max-w-sm animacion-tarjeta"
        style={{ animationDelay: "0.1s" }}
      >
        <h2 className="text-xl font-bold text-white mb-1">Prueba Técnica</h2>
        <p className="text-gray-300 text-sm mb-6">
          Utilice estas credenciales para validar el sistema.
        </p>

        <div className="space-y-4 mb-6">
          <div className="bg-white/10 border border-white/10 p-4 rounded-lg flex justify-between items-center group">
            <div>
              <p className="text-[#E5B869] text-xs font-bold mb-1 uppercase">
                Usuario de prueba 1
              </p>
        ...
        <div className="pt-4 border-t border-white/20">
          <p className="text-gray-300 text-xs font-semibold mb-3 tracking-wider text-center">
            ENLACES DIRECTOS
          </p>
